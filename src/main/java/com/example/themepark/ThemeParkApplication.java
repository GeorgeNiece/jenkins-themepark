...
import com.example.themepark.models.ThemeParkRide;
import com.example.themepark.repository.ThemeParkRideRepository;
...
public class ThemeParkApplication  {
    ...
    public CommandLineRunner sampleData(ThemeParkRideRepository repository) {
        return (args) -> {
            ...
            repository.save(new ThemeParkRide("SteelVenom", "Insane death coaster.", 5, 5));
